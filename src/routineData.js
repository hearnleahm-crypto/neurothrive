...
export const ROUTINE_STEP_LIBRARY = {
  morning: [
    ...
    { id:"m_journal", title:"Morning Journal", time:5, desc:"Write freely for 5 minutes — whatever comes to mind. Stream-of-consciousness writing activates the default mode network in a controlled way, helping your brain process overnight emotional residue before it colors your entire day.", conditions:["all"], struggles:["racing_thoughts","anxiety","motivation"], tags:["journaling","processing"], order:7, priority:8 },
