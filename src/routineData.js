...
export const ROUTINE_STEP_LIBRARY = {
  morning: [
    ...
    { id:"m_meditation", title:"Guided Meditation", time:10, desc:"Close your eyes and follow a meditation practice. Meditation thickens the prefrontal cortex and shrinks the amygdala over time, rewiring the brain regions that govern focus, emotional regulation, and threat response.", conditions:["anxiety","ptsd","ocd","bpd","depression","neuro_core"], struggles:["anxiety","focus"], tags:["mindfulness","meditation"], requiresMeditation:true, order:5, priority:8 },
  ...
  evening: [
    ...
    { id:"e_worry_time", title:"Scheduled Worry Time", time:5, desc:"Set a timer for 5 minutes and worry deliberately. When the timer ends, close the notebook. This paradoxical technique trains your brain that worry has a container, reducing the intrusive thoughts that keep you awake at bedtime.", conditions:["anxiety","ocd","ptsd","bpd"], struggles:["racing_thoughts","sleep"], tags:["processing","anxiety_tool"], order:1, priority:8 },
    { id:"e_journal", title:"Evening Reflection", time:5, desc:"Write about one thing that went well and one thing you'd change. This balanced reflection activates both the reward system (what worked) and the learning system (what to adjust), counteracting the negativity bias your brain amplifies at night.", conditions:["depression","bpd","anxiety","default"], struggles:["stress","racing_thoughts"], tags:["journaling","reflection"], order:2, priority:8 },
    ...
    { id:"e_body_scan_sleep", title:"Sleep Body Scan", time:10, desc:"Lying in bed, slowly relax each muscle group from toes to head. Progressive muscle relaxation reduces physiological arousal by 30–40%, directly counteracting the hypervigilance that stress and racing thoughts create at bedtime.", conditions:["anxiety","ptsd","ocd","bpd","default"], struggles:["sleep","stress","racing_thoughts"], tags:["meditation","body_awareness"], order:8, priority:7 },
