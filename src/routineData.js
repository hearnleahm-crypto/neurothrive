...
export const ROUTINE_STEP_LIBRARY = {
  morning: [
    ...
    { id:"m_gratitude", title:"Three Gratitudes", time:3, desc:"Write or think of 3 things you're grateful for. Gratitude practice increases dopamine and serotonin production. Studies show 21 consecutive days of this practice rewires your brain's default negativity bias.", conditions:["depression","anxiety","bpd","default"], struggles:["motivation","anxiety"], tags:["intention","positive"], order:6, priority:8 },
    ...
    { id:"m_journal", title:"Morning Pages", time:10, desc:"Write freely for 10 minutes — whatever comes to mind. Stream-of-consciousness writing activates the default mode network in a controlled way, helping your brain process overnight emotional residue before it colors your entire day.", conditions:["anxiety","ptsd","bpd","depression","ocd"], struggles:["racing_thoughts","anxiety"], tags:["journaling","processing"], order:7, priority:6 },
