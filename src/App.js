...
const ALL_MEALS = {
  breakfast: [
    ...
    { name: "Overnight Oats with Chia & Mixed Berries", tags: ["gluten","seed"], conditions: ["bpd","ocd","default"] },
    ...
    { name: "Overnight Oats with Chia, Berries & Honey", tags: ["gluten","seed"], conditions: ["ocd","default"] },
    ...
    { name: "Oat & Blueberry Pancakes with Honey", tags: ["gluten","egg"], conditions: ["depression","ocd","schizophrenia","default"] },
