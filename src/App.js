...
const ALL_MEALS = {
  breakfast: [
    ...
    { name: "Ground Turkey Bowl with Sautéed Spinach & Sliced Kiwi", tags: ["meat"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","ocd","bpd","default"] },
    ...
    { name: "Grilled Chicken with Watermelon & Blueberry Bowl", tags: ["meat"], conditions: ["adhd","depression","anxiety","ptsd","schizophrenia","neuro_core","default"] },
    ...
    { name: "Turkey & Spinach Sauté with Sliced Peaches & Raspberries", tags: ["meat"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","ocd","bpd","default"] },
    { name: "Chicken & Sweet Potato Hash with Blueberry & Banana Side", tags: ["meat"], conditions: ["adhd","depression","anxiety","ptsd","schizophrenia","neuro_core","default"] },
    ...
    { name: "Ground Turkey with Papaya, Lime & Blueberry Bowl", tags: ["meat","citrus"], conditions: ["adhd","depression","anxiety","ptsd","schizophrenia","neuro_core","default"] },
    ...
    { name: "Turkey Sauté with Strawberry, Banana & Sunflower Seeds", tags: ["meat","seed"], conditions: ["adhd","depression","anxiety","bipolar","ocd","neuro_core","default"] },
    ...
    { name: "Grilled Chicken & Spinach Breakfast Wrap", tags: ["gluten","meat"], conditions: ["anxiety","depression","bipolar","ptsd","ocd","bpd","default"] },
    ...
    { name: "Chicken Sausage with Roasted Peppers & Zucchini", tags: ["meat"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","default"] },
    { name: "Lentil & Veggie Breakfast Bowl", tags: ["legume"], conditions: ["depression","anxiety","ocd","bipolar","ptsd","aspd","bfrb","spd","default"] },
    ...
    { name: "Turkey Sausage with Roasted Sweet Potato Hash", tags: ["meat"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","ocd","default"] },
    ...
    { name: "Sweet Potato & Black Bean Breakfast Burrito", tags: ["gluten","legume"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","ocd","bpd","default"] },
    ...
    { name: "Turkey & Egg Breakfast Wrap with Spinach", tags: ["meat","egg","gluten"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","bpd","bfrb","aspd","default"] },
    ...
    { name: "Chicken Sausage & Egg Scramble with Rice & Avocado", tags: ["meat","egg","rice"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","ocd","bpd","neuro_core","default"] },
    { name: "Turkey & Egg Breakfast Bowl with Quinoa & Roasted Veggies", tags: ["meat","egg","quinoa"], conditions: ["adhd","anxiety","bipolar","ptsd","ocd","bpd","default"] },
    { name: "Egg & Chicken Sausage Skillet with Roasted Potatoes & Peppers", tags: ["meat","egg","nightshade","potato"], conditions: ["adhd","depression","bipolar","default"] },
    ...
    { name: "Ground Turkey & Egg Breakfast Skillet with Rice", tags: ["meat","egg","rice"], conditions: ["adhd","bipolar","schizophrenia","default"] },
    ...
    { name: "Hearty Egg Scramble with Chicken, Rice & Black Beans", tags: ["egg","meat","rice","legume"], conditions: ["adhd","depression","bipolar","default"] },
    ...
    { name: "Turkey Sausage & Egg Plate with Roasted Potatoes & Spinach", tags: ["meat","egg","potato"], conditions: ["adhd","depression","bipolar","ptsd","schizophrenia","did","default"] },
  ...
  lunch: [
    ...
    { name: "Turkey & Avocado Wrap with a Side of Sliced Mango", tags: ["meat","gluten"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","ocd","bpd","neuro_core","default"] },
    ...
    { name: "Chicken & Mango Rice Bowl", tags: ["meat","rice"], conditions: ["adhd","depression","bipolar","anxiety","ocd","default"] },
    ...
    { name: "Chicken Thigh Bowl with Blueberry & Cucumber Salad", tags: ["meat"], conditions: ["adhd","depression","anxiety","ptsd","schizophrenia","neuro_core","default"] },
    { name: "Turkey & Avocado Bowl with Sliced Kiwi on the Side", tags: ["meat"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","ocd","bpd","neuro_core","default"] },
    ...
    { name: "Grilled Chicken Wrap with Avocado & Lettuce", tags: ["meat","gluten"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","ocd","bpd","neuro_core","default"] },
    { name: "Turkey & Avocado Salad with Lemon Dressing", tags: ["meat"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","ocd","bpd","neuro_core","default"] },
    { name: "Chicken & Veggie Soup with Crusty Bread", tags: ["meat","gluten"], conditions: ["anxiety","depression","default"] },
    { name: "Lentil & Roasted Veggie Bowl", tags: ["legume"], conditions: ["depression","anxiety","ocd","bipolar","ptsd","default"] },
    { name: "Chickpea & Spinach Salad with Lemon Tahini", tags: ["legume","citrus","seed"], conditions: ["depression","anxiety","ocd","bipolar","ptsd","bpd","default"] },
    { name: "Veggie & Black Bean Burrito Bowl", tags: ["legume"], conditions: ["depression","anxiety","ocd","bipolar","ptsd","default"] },
    ...
    { name: "Turkey & Lentil Soup with Whole Grain Roll", tags: ["meat","gluten","legume"], conditions: ["depression","anxiety","ocd","bipolar","ptsd","default"] },
    { name: "Roasted Veggie & Quinoa Salad", tags: ["quinoa"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","default"] },
    { name: "White Bean & Kale Soup", tags: ["legume"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","bpd","default"] },
    { name: "Grilled Chicken & Rice Bowl", tags: ["meat","rice"], conditions: ["adhd","depression","anxiety","bipolar","ocd","ptsd","default"] },
    { name: "Turkey & Cheese Sandwich on Whole Grain Bread", tags: ["meat","gluten","dairy"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","default"] },
    { name: "Grilled Chicken Salad with Strawberries & Balsamic", tags: ["meat"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","default"] },
    { name: "Turkey & Veggie Wrap with Side Fruit", tags: ["meat","gluten"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","default"] },
    { name: "Chicken & Lentil Soup with Crusty Bread", tags: ["meat","gluten","legume"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","default"] },
    { name: "Grilled Chicken Sandwich with Side Salad", tags: ["meat","gluten"], conditions: ["depression","anxiety","bipolar","ptsd","schizophrenia","default"] },
    { name: "Tomato Soup with Grilled Cheese on Whole Grain", tags: ["gluten","dairy"], conditions: ["schizophrenia","did","default"] },
    { name: "Turkey Wrap with Spinach & Avocado", tags: ["meat","gluten"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","ocd","bpd","schizophrenia","neuro_core","default"] },
    { name: "Chicken & Veggie Soup with Whole Grain Roll", tags: ["meat","gluten"], conditions: ["schizophrenia","ptsd","default"] },
    { name: "Grilled Chicken & Avocado Salad", tags: ["meat"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","ocd","bpd","neuro_core","default"] },
    { name: "Turkey & Veggie Wrap with Greek Yogurt Dip", tags: ["meat","gluten","dairy"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","default"] },
    ...
    { name: "Turkey & Avocado Wrap with Side Fruit", tags: ["meat","gluten"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","ocd","bpd","did","neuro_core","default"] },
    { name: "Chicken Noodle Soup with Whole Grain Roll", tags: ["meat","gluten"], conditions: ["did","default"] },
    { name: "Grilled Chicken Salad with Lemon Vinaigrette", tags: ["meat"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","bpd","default"] },
    { name: "Turkey Club Sandwich with Side Salad", tags: ["meat","gluten","dairy"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","bpd","default"] },
    { name: "Grilled Chicken & Avocado Wrap", tags: ["meat","gluten"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","ocd","bpd","neuro_core","default"] },
    { name: "Turkey & Spinach Salad with Balsamic Dressing", tags: ["meat"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","bpd","default"] },
    { name: "Grilled Chicken Caesar Wrap", tags: ["meat","gluten","dairy"], conditions: ["bpd","ocd","default"] },
    { name: "Grilled Chicken & Veggie Wrap", tags: ["meat","gluten"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","default"] },
    { name: "Turkey Soup with Whole Grain Roll", tags: ["meat","gluten"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","default"] },
    { name: "Turkey & Avocado Wrap with Side Salad", tags: ["meat","gluten"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","ocd","bpd","neuro_core","default"] },
    ...
    { name: "Chicken Burrito on a Flour Tortilla with Rice & Black Beans", tags: ["meat","gluten","legume","rice"], conditions: ["adhd","anxiety","default"] },
    ...
    { name: "Rice & Grilled Chicken Bowl with Steamed Broccoli", tags: ["meat","rice"], conditions: ["schizophrenia","bipolar","ocd","ptsd","hpd","bfrb","phobia","default"] },
    ...
    { name: "Turkey & Rice Stuffed Peppers", tags: ["meat","rice","nightshade"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","schizophrenia","default"] },
    { name: "Lentil & Rice Bowl with Roasted Vegetables", tags: ["legume","rice"], conditions: ["depression","anxiety","ocd","aspd","bfrb","spd","default"] },
    ...
    { name: "Pomegranate & Chicken Grain Bowl with Quinoa", tags: ["meat","quinoa"], conditions: ["ptsd","depression","schizophrenia","default"] },
    { name: "Sushi Bowl with Salmon & Edamame", tags: ["fish","rice","soy","legume"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","schizophrenia","neuro_core","hpd","default"] },
    { name: "Chicken & Sweet Potato Bowl with Rice", tags: ["meat","rice"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","schizophrenia","did","default"] },
    ...
    { name: "Lentil Soup with Spinach & Rice", tags: ["legume","rice"], conditions: ["depression","anxiety","ocd","ptsd","aspd","spd","bfrb","default"] },
    { name: "Chicken & Lentil Rice Bowl", tags: ["meat","legume","rice"], conditions: ["bipolar","schizophrenia","ocd","default"] },
    ...
    // ── Condition-specific: NPD, HPD, ASPD, Eating, Phobia, BFRB, PPD, SPD, Neuro Core ──
    { name: "Grilled Chicken & Chickpea Bowl with Tahini Dressing", tags: ["meat","legume","seed"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","npd","aspd","default"] },
    ...
    { name: "Grilled Chicken & Brussels Sprout Bowl with Rice", tags: ["meat","rice"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","bfrb","default"] },
    { name: "Grilled Chicken & Lentil Bowl with Spinach & Tahini", tags: ["meat","legume","seed"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","bpd","spd","neuro_core","default"] },
    { name: "Turkey Burger with Sweet Potato Fries & Side Salad", tags: ["meat","gluten"], conditions: ["spd","eating","default"] },
    { name: "Chicken & Spinach Stir-Fry with Quinoa", tags: ["meat","quinoa"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","bpd","phobia","npd","default"] },
    ...
    { name: "Kimchi Rice Bowl with Grilled Chicken & Steamed Veggies", tags: ["meat","rice"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","schizophrenia","hpd","neuro_core","ppd","default"] },
    ...
    // ── Brain-boosting: Turmeric, Fermented, Lion's Mane, Sardine ──
    { name: "Turmeric Chicken & Rice Bowl with Roasted Veggies", tags: ["meat","rice"], conditions: ["depression","anxiety","ptsd","bipolar","ocd","neuro_core","default"] },
    ...
    { name: "Lion's Mane Mushroom Stir-Fry with Chicken & Rice", tags: ["meat","mushroom","rice"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","schizophrenia","neuro_core","default"] },
    { name: "Kimchi & Chicken Grain Bowl with Pickled Vegetables", tags: ["meat","rice"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","schizophrenia","neuro_core","default"] },
    ...
    { name: "Loaded Baked Potato with Chicken & Broccoli", tags: ["meat","potato","dairy"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","ocd","bpd","did","default"] },
    { name: "Chicken & Potato Soup with Fresh Herbs", tags: ["meat","potato"], conditions: ["anxiety","depression","ptsd","ocd","eating","did","default"] },
    { name: "Grilled Chicken Plate with Roasted Potatoes & Side Salad", tags: ["meat","potato"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","ocd","schizophrenia","neuro_core","default"] },
    { name: "Turkey & Potato Hash Bowl with Avocado", tags: ["meat","potato"], conditions: ["adhd","depression","bipolar","ptsd","bpd","default"] },
  ],
  dinner: [
    { name: "Pan-Seared Steak with Roasted Sweet Potato & Fresh Blueberry Side", tags: ["meat"], conditions: ["adhd","default"] },
    { name: "Baked Chicken Thighs with Roasted Pineapple & Quinoa", tags: ["meat","quinoa"], conditions: ["adhd","default"] },
    ...
    { name: "Chicken Thighs with Cherry Tomato Sauce & Quinoa", tags: ["meat","quinoa"], conditions: ["adhd","default"] },
    ...
    { name: "Chicken Thigh with Roasted Pineapple, Peppers & Rice", tags: ["meat","rice","nightshade"], conditions: ["adhd","depression","bipolar","anxiety","ocd","default"] },
    ...
    { name: "Grilled Chicken Thighs with Roasted Zucchini & Rice", tags: ["meat"], conditions: ["anxiety","depression","bipolar","ptsd","ocd","default"] },
    ...
    { name: "Roasted Veggie & Chickpea Curry with Rice", tags: ["legume","rice"], conditions: ["anxiety","depression","default"] },
    ...
    { name: "Lemon Herb Chicken with Rice Pilaf", tags: ["meat","rice","citrus"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","default"] },
    ...
    { name: "Oven-Baked Chicken Thighs with Roasted Root Vegetables", tags: ["meat"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","default"] },
    { name: "Lean Ground Beef Tacos with Black Beans", tags: ["meat","legume"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","default"] },
    { name: "Sirloin Steak with Roasted Potatoes & Green Beans", tags: ["meat","potato"], conditions: ["bipolar","bpd","default"] },
    { name: "Baked Chicken Breast with Quinoa & Roasted Zucchini", tags: ["meat","quinoa"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","default"] },
    { name: "Ground Turkey Stuffed Bell Peppers with Rice", tags: ["meat","rice","nightshade"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","default"] },
    { name: "Chicken & White Bean Stew", tags: ["meat","legume"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","default"] },
    { name: "Baked Chicken Breast with Roasted Veggies & Rice", tags: ["meat","rice"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","schizophrenia","default"] },
    ...
    { name: "Grilled Chicken Thighs with Roasted Sweet Potato", tags: ["meat"], conditions: ["depression","anxiety","bipolar","ptsd","schizophrenia","default"] },
    ...
    { name: "Baked Lemon Herb Chicken with Roasted Potatoes", tags: ["meat","potato"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","default"] },
    ...
    { name: "Oven-Roasted Chicken with Root Vegetables & Quinoa", tags: ["meat","quinoa"], conditions: ["ptsd","default"] },
    { name: "Baked Chicken with Mashed Potatoes & Green Beans", tags: ["meat","potato"], conditions: ["did","eating","default"] },
    { name: "Ground Beef Pasta with Marinara Sauce", tags: ["meat","gluten"], conditions: ["depression","bipolar","ptsd","did","default"] },
    { name: "Grilled Steak with Mashed Potatoes & Green Beans", tags: ["meat","potato"], conditions: ["did","default"] },
    { name: "Ground Turkey Taco Bowl with Rice & Beans", tags: ["meat","rice","legume"], conditions: ["adhd","depression","anxiety","bipolar","did","default"] },
    ...
    { name: "Baked Chicken Thighs with Garlic Mashed Potatoes", tags: ["meat","dairy","potato"], conditions: ["bpd","default"] },
    ...
    { name: "Baked Chicken Thighs with Roasted Cauliflower & Rice", tags: ["meat"], conditions: ["bpd","default"] },
    { name: "Oven-Roasted Chicken with Vegetables & Quinoa", tags: ["meat","quinoa"], conditions: ["ocd","default"] },
    { name: "Lean Beef Stir-Fry with Noodles & Mixed Veggies", tags: ["meat","gluten"], conditions: ["ocd","default"] },
    { name: "Chicken & Veggie Stir-Fry with Rice", tags: ["meat","rice"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","ocd","default"] },
    { name: "Grilled Steak with Roasted Potatoes & Asparagus", tags: ["meat","potato"], conditions: ["ocd","default"] },
    { name: "Baked Chicken Thighs with Rice & Broccoli", tags: ["meat"], conditions: ["ocd","default"] },
    ...
    { name: "Baked Chicken Breast with Corn & Mashed Potatoes", tags: ["meat","corn","dairy","potato"], conditions: ["autism","default"] },
    ...
    { name: "Baked Salmon with Mashed Sweet Potato & Green Beans", tags: ["fish"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","schizophrenia","neuro_core","ppd","hpd","phobia","npd","spd","default"] },
    ...
    { name: "Baked Salmon with Sweet Potato & Green Beans", tags: ["fish"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","schizophrenia","neuro_core","phobia","hpd","ppd","spd","default"] },
    ...
    { name: "Brisket & Black Bean Bowl with Rice & Roasted Corn", tags: ["meat","corn","rice","legume"], conditions: ["adhd","depression","default"] },
    ...
    { name: "Sweet Potato & Lentil Curry with Rice", tags: ["legume","rice"], conditions: ["anxiety","depression","bipolar","ptsd","ocd","aspd","bfrb","spd","hpd","default"] },
    ...
    { name: "Chicken & Rice Stir-Fry with Mixed Veggies", tags: ["meat","rice"], conditions: ["adhd","bipolar","schizophrenia","ocd","default"] },
    { name: "Baked Sweet Potato Stuffed with Black Beans & Avocado", tags: ["legume"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","ocd","bpd","neuro_core","default"] },
    ...
    { name: "Lentil Bolognese over Rice Pasta", tags: ["legume","gluten"], conditions: ["depression","anxiety","ocd","bipolar","default"] },
    { name: "Turkey Meatballs with Rice & Steamed Broccoli", tags: ["meat","rice"], conditions: ["adhd","bipolar","schizophrenia","did","default"] },
    ...
    { name: "Ground Turkey & Sweet Potato Skillet with Rice", tags: ["meat","rice"], conditions: ["adhd","bipolar","schizophrenia","default"] },
    { name: "Chicken & Quinoa Bowl with Pomegranate & Spinach", tags: ["meat","quinoa"], conditions: ["ptsd","depression","schizophrenia","default"] },
    { name: "Rice Bowl with Grilled Chicken & Roasted Veggies", tags: ["meat","rice"], conditions: ["bipolar","ocd","did","bpd","default"] },
    { name: "Salmon Teriyaki with Rice & Steamed Edamame", tags: ["fish","rice","soy","legume"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","schizophrenia","neuro_core","npd","spd","default"] },
    { name: "Stuffed Sweet Potatoes with Ground Turkey & Cheese", tags: ["meat","dairy"], conditions: ["adhd","depression","did","default"] },
    { name: "Lentil & Rice Stuffed Bell Peppers", tags: ["legume","rice","nightshade"], conditions: ["depression","anxiety","ocd","bipolar","default"] },
    ...
    { name: "Chicken & Vegetable Bone Broth Soup with Rice", tags: ["meat","rice"], conditions: ["ppd","eating","default"] },
    { name: "Garlic Chicken Stir-Fry with Broccoli & Rice", tags: ["meat","rice","onion"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","bfrb","default"] },
    { name: "Baked Chicken Thighs with Roasted Brussels Sprouts & Sweet Potato", tags: ["meat"], conditions: ["depression","anxiety","bipolar","ptsd","bfrb","hpd","default"] },
    ...
    { name: "Baked Chicken with Mashed Potatoes & Buttered Green Beans", tags: ["meat","dairy","potato"], conditions: ["eating","did","ppd","default"] },
    ...
    { name: "Chicken & Chickpea Curry with Turmeric Rice & Spinach", tags: ["meat","legume","rice"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","schizophrenia","bpd","spd","neuro_core","default"] },
    ...
    { name: "Turmeric Coconut Curry with Chicken & Rice", tags: ["meat","coconut","rice"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","schizophrenia","neuro_core","default"] },
    ...
    { name: "Golden Turmeric Chicken Soup with Vegetables & Rice", tags: ["meat","rice"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","schizophrenia","did","ppd","neuro_core","default"] },
    ...
    { name: "Lion's Mane & Chicken Sheet Pan with Roasted Sweet Potato", tags: ["meat","mushroom"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","schizophrenia","neuro_core","default"] },
    { name: "Herb-Roasted Chicken with Garlic Potatoes & Steamed Veggies", tags: ["meat","potato"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","ocd","bpd","schizophrenia","autism","did","eating","neuro_core","default"] },
    ...
    { name: "Loaded Baked Potato with Ground Turkey & Steamed Broccoli", tags: ["meat","potato","dairy"], conditions: ["adhd","depression","bipolar","ptsd","did","default"] },
    { name: "Shepherd's Pie with Ground Turkey & Mashed Potato Topping", tags: ["meat","potato"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","bpd","did","eating","default"] },
    { name: "Crispy Baked Potato Wedges with Grilled Chicken & Salad", tags: ["meat","potato"], conditions: ["adhd","anxiety","ocd","autism","bpd","default"] },
  ],
  snacks: [
    ...
    { name: "Celery & Hummus", tags: ["legume","seed"], conditions: ["depression","anxiety","ocd","bipolar","ptsd","default"] },
    ...
    { name: "Cucumber Slices & Hummus", tags: ["legume","seed"], conditions: ["depression","anxiety","ocd","bipolar","ptsd","default"] },
    ...
    { name: "Roasted Chickpeas", tags: ["legume"], conditions: ["depression","anxiety","ocd","bipolar","ptsd","default"] },
    ...
    { name: "Edamame with Sea Salt", tags: ["soy","legume"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","default"] },
