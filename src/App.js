...
const SUPPLEMENTS = {
  ...
  default: [
    ...
    { name:"Vitamin D3 + K2", dose:"2000–4000 IU D3 with 100mcg K2", emoji:"☀️", science:"Vitamin D is technically a neurosteroid. Deficiency — extremely common especially in northern climates — is linked to depression, cognitive decline, and immune dysfunction.", why:"Vitamin D receptors exist in almost every brain region. Deficiency reduces serotonin and dopamine gene expression, blunts cognitive function, and increases susceptibility to depression and anxiety. Most adults in northern climates are deficient for 6 months of the year without supplementation.", timing:"Morning with a fatty meal.", caution:"Test your blood levels first. K2 ensures calcium goes to bones, not arteries.", link:"https://pubmed.ncbi.nlm.nih.gov/22254078/" },
        ...
        {step === 6 && (
          <div>
            ...
            <div style={{ background:"rgba(200,190,160,0.08)", border:"1px solid rgba(200,190,160,0.2)", borderRadius:"14px", padding:"14px 18px", marginBottom:"24px" }}>
              <div style={{ fontSize:"11px", textTransform:"uppercase", letterSpacing:"2px", color:"#8890b8", fontWeight:"600", marginBottom:"6px" }}>⚕️ Wellness Information Only</div>
              <p style={{ color:"#8890b8", fontSize:"13px", lineHeight:1.7, margin:0 }}>These suggestions are based on peer-reviewed research and are provided for educational purposes only. They are <strong style={{color:"#c8ccf0"}}>not medical advice</strong> and are not intended to diagnose, treat, or replace any prescribed medication. Always speak with your healthcare provider before starting supplements, especially if you take medication or have a health condition.</p>
            </div>
            {(() => {
