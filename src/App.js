...
const ALL_MEALS = {
  ...
  dinner: [
    ...
    { name: "Baked Lemon Herb Chicken with Roasted Potatoes", tags: ["meat"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","default"] },
...
const SUPPLEMENTS = {
  ...
  depression: [
    ...
    { name:"Brain Mineral Complex", dose:"", emoji:"💎", science:"Zinc, magnesium, selenium, chromium, and iron deficiencies are each independently linked to depression in large epidemiological studies. Zinc adjunctive therapy has strong RCT evidence for improving antidepressant response.", why:"Depression depletes and is worsened by mineral deficiencies in a vicious cycle. Zinc is required for BDNF production (the growth factor antidepressants work by restoring). Magnesium blocks the NMDA hyperactivity that drives depressive rumination. Selenium protects serotonin-producing neurons from oxidative damage. Correcting mineral status can meaningfully accelerate recovery.", timing:"With meals. Zinc and iron at separate meals for best absorption.", caution:"Test iron and zinc levels before supplementing. Selenium should not exceed 200mcg/day. Always inform your prescriber.", link:"https://pubmed.ncbi.nlm.nih.gov/23806573/", minerals:[
