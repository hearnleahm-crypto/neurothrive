...
const FOOD_PREFS = [
  ...
  { id: "beans", label: "Beans & Chickpeas", emoji: "🫛" },
...
const FOOD_PREF_PATTERNS = {
  ...
  lentils: /lentil/i,
  beans: /bean|chickpea|hummus|falafel|edamame/i,
...
const ALL_MEALS = {
  breakfast: [
    ...
    { name: "Chicken & Sweet Potato Hash with Blueberry & Banana Side", tags: ["chicken","meat"], conditions: ["adhd","depression","anxiety","ptsd","schizophrenia","neuro_core","default"] },
    ...
    { name: "Turkey Sauté with Strawberry, Banana & Sunflower Seeds", tags: ["meat","seed","turkey"], conditions: ["adhd","depression","anxiety","bipolar","ocd","neuro_core","default"] },
    ...
    { name: "Warm Oatmeal with Sliced Banana & Walnuts", tags: ["gluten","oats","nuts"], conditions: ["adhd","depression","anxiety","bipolar","ocd","neuro_core","default"] },
    { name: "Smoothie Bowl with Spinach, Banana & Granola", tags: ["gluten"], conditions: ["anxiety","depression","bipolar","ptsd","ocd","bpd","default"] },
    { name: "Whole Grain Pancakes with Sliced Strawberries & Honey", tags: ["egg","gluten","dairy"], conditions: ["anxiety","default"] },
    { name: "Banana Smoothie with Almond Milk & Chia Seeds", tags: ["nuts","seed"], conditions: ["adhd","depression","anxiety","bipolar","ocd","neuro_core","default"] },
    ...
    { name: "Scrambled Eggs & Whole Grain Toast with Sliced Banana", tags: ["egg","gluten"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","default"] },
    ...
    { name: "Banana Oat Pancakes with Maple Syrup & Blueberries", tags: ["egg","gluten","dairy"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","bpd","schizophrenia","neuro_core","default"] },
    ...
    { name: "Whole Grain Cereal with Milk & Sliced Banana", tags: ["gluten","dairy"], conditions: ["depression","anxiety","bipolar","ptsd","schizophrenia","default"] },
    ...
    { name: "Smoothie with Spinach, Banana & Almond Milk", tags: ["nuts"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","ocd","bpd","neuro_core","default"] },
    { name: "Whole Grain Toast with Peanut Butter & Sliced Banana", tags: ["gluten","nuts"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","ocd","neuro_core","default"] },
    ...
    { name: "Smoothie with Banana, Peanut Butter & Oat Milk", tags: ["gluten","oats","nuts"], conditions: ["adhd","depression","anxiety","bipolar","ocd","did","neuro_core","default"] },
    { name: "Overnight Oats with Banana & Almond Butter", tags: ["gluten","oats","nuts"], conditions: ["adhd","depression","anxiety","bipolar","ocd","did","bpd","neuro_core","default"] },
    ...
    { name: "Whole Grain Toast with Peanut Butter & Banana", tags: ["gluten","nuts"], conditions: ["adhd","depression","anxiety","bipolar","ocd","neuro_core","default"] },
    ...
    { name: "Grilled Sourdough with Almond Butter & Sliced Banana", tags: ["gluten","nuts"], conditions: ["adhd","depression","anxiety","bipolar","ocd","neuro_core","default"] },
    ...
    { name: "Rice Porridge with Cinnamon & Sliced Banana", tags: ["rice"], conditions: ["anxiety","autism","did","default"] },
    ...
    { name: "Blueberry Banana Smoothie with Oat Milk", tags: ["gluten","oats"], conditions: ["adhd","depression","anxiety","ptsd","schizophrenia","neuro_core","default"] },
    ...
    { name: "Scrambled Eggs with Broccoli, Garlic & Whole Grain Toast", tags: ["egg","gluten","onion"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","bfrb","neuro_core","default"] },
    { name: "Green Tea Smoothie with Banana, Spinach & Almond Butter", tags: ["nuts"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","ocd","bpd","phobia","hpd","neuro_core","default"] },
    ...
    { name: "Warm Oatmeal with Pumpkin Seeds, Banana & Honey", tags: ["gluten","oats","seed"], conditions: ["adhd","depression","anxiety","bipolar","ocd","ppd","npd","aspd","neuro_core","default"] },
    { name: "Scrambled Eggs with Toast & Fresh Fruit Salad", tags: ["egg","gluten"], conditions: ["eating","did","default"] },
    { name: "Banana & Almond Smoothie with Egg & Honey", tags: ["nuts","egg"], conditions: ["adhd","depression","anxiety","bipolar","ocd","spd","neuro_core","default"] },
    ...
    { name: "Golden Turmeric Oatmeal with Banana & Walnuts", tags: ["gluten","oats","nuts"], conditions: ["depression","anxiety","ptsd","bipolar","schizophrenia","ocd","bpd","neuro_core","default"] },
  ...
  lunch: [
    ...
    { name: "Chickpea & Spinach Salad with Lemon Tahini", tags: ["legume","bean","citrus","seed"], conditions: ["depression","anxiety","ocd","bipolar","ptsd","bpd","default"] },
    ...
    { name: "Sweet Potato & Chickpea Curry Bowl", tags: ["legume","bean"], conditions: ["anxiety","depression","ptsd","hpd","phobia","ppd","spd","default"] },
    ...
    // ── Condition-specific: NPD, HPD, ASPD, Eating, Phobia, BFRB, PPD, SPD, Neuro Core ──
    { name: "Grilled Chicken & Chickpea Bowl with Tahini Dressing", tags: ["chicken","meat","legume","bean","seed"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","npd","aspd","default"] },
  ...
  dinner: [
    ...
    { name: "Roasted Veggie & Chickpea Curry with Rice", tags: ["legume","bean","rice"], conditions: ["anxiety","depression","default"] },
    ...
    { name: "Baked Chicken Thighs with Garlic Mashed Potatoes", tags: ["chicken","meat","dairy","potato"], conditions: ["bpd","default"] },
    ...
    { name: "Baked Salmon with Garlic Mashed Sweet Potato", tags: ["fish"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","schizophrenia","bpd","neuro_core","ppd","phobia","default"] },
    ...
    { name: "Garlic Chicken Stir-Fry with Broccoli & Rice", tags: ["chicken","meat","rice","onion"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","bfrb","default"] },
    ...
    { name: "Pasta with Marinara Sauce, Grilled Chicken & Garlic Bread", tags: ["chicken","meat","gluten","onion"], conditions: ["eating","did","default"] },
    ...
    { name: "Chicken & Chickpea Curry with Turmeric Rice & Spinach", tags: ["chicken","meat","legume","bean","rice"], conditions: ["depression","anxiety","bipolar","ptsd","ocd","schizophrenia","bpd","spd","neuro_core","default"] },
    ...
    { name: "Herb-Roasted Chicken with Garlic Potatoes & Steamed Veggies", tags: ["chicken","meat","potato"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","ocd","bpd","schizophrenia","autism","did","eating","neuro_core","default"] },
  ...
  snacks: [
    ...
    { name: "Banana + Chicken Jerky", tags: ["chicken","meat"], conditions: ["adhd","default"] },
    ...
    { name: "Banana with Almond Butter", tags: ["nuts"], conditions: ["adhd","depression","anxiety","bipolar","ocd","neuro_core","default"] },
    { name: "Celery & Hummus", tags: ["legume","bean","seed"], conditions: ["depression","anxiety","ocd","bipolar","ptsd","default"] },
    ...
    { name: "Cucumber Slices & Hummus", tags: ["legume","bean","seed"], conditions: ["depression","anxiety","ocd","bipolar","ptsd","default"] },
    ...
    { name: "Banana with Walnut Butter", tags: ["nuts"], conditions: ["adhd","depression","anxiety","bipolar","ocd","neuro_core","default"] },
    ...
    { name: "Roasted Chickpeas", tags: ["legume","bean"], conditions: ["depression","anxiety","ocd","bipolar","ptsd","default"] },
    { name: "Apple & Peanut Butter", tags: ["nuts"], conditions: ["adhd","depression","anxiety","bipolar","ocd","neuro_core","default"] },
    { name: "Hummus with Carrot & Cucumber Sticks", tags: ["legume","bean","seed"], conditions: ["bipolar","anxiety","default"] },
    { name: "Banana with a Handful of Walnuts", tags: ["nuts"], conditions: ["adhd","depression","anxiety","bipolar","ocd","neuro_core","default"] },
    ...
    { name: "Banana & a Few Walnuts", tags: ["nuts"], conditions: ["adhd","depression","anxiety","bipolar","ptsd","ocd","neuro_core","default"] },
    ...
    { name: "Sweet Potato Hummus with Veggie Sticks", tags: ["legume","bean","seed"], conditions: ["anxiety","ptsd","bipolar","default"] },
    ...
    // ── Condition-specific: NPD, HPD, ASPD, Eating, Phobia, BFRB, PPD, SPD, Neuro Core ──
    { name: "Pumpkin Seed & Banana Trail Mix", tags: ["seed"], conditions: ["adhd","depression","anxiety","bipolar","ocd","npd","ppd","aspd","neuro_core","default"] },
    ...
    { name: "Almonds & Dark Chocolate with a Banana", tags: ["nuts"], conditions: ["adhd","depression","anxiety","bipolar","ocd","ppd","phobia","neuro_core","default"] },
