...
export default function NeuroThrive() {
  ...
  const S = {
    ...
    navTabs: { display:"flex", gap:"6px", overflowX:"auto", WebkitOverflowScrolling:"touch", scrollbarWidth:"none", msOverflowStyle:"none", flexShrink:1, minWidth:0 },
    navTab: (a) => ({ padding:"7px 12px", borderRadius:"10px", border:a?"1px solid rgba(107,143,255,0.3)":"1px solid rgba(107,143,255,0.1)", cursor:"pointer", fontSize:"11px", fontWeight:a?"600":"500", background:a?"rgba(107,143,255,0.12)":"rgba(255,255,255,0.03)", color:a?"#a0b8ff":"#6b7394", transition:"all 0.2s cubic-bezier(0.25,0.46,0.45,0.94)", letterSpacing:"0.01em", whiteSpace:"nowrap", flexShrink:0 }),
